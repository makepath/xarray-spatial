...
from xrspatial.flow_path_dinf import _angle_to_neighbors_py
from xrspatial._boundary_store import BoundaryStore
from xrspatial.watershed_dinf import (
    _dominant_offset_py,
    _preprocess_tiles,
    _to_numpy_f64,
)
...
def _compute_exit_labels(iy, ix, boundaries, flow_bdry,
    ...
    from xrspatial.watershed_dinf import _compute_exit_labels as _ws_compute
