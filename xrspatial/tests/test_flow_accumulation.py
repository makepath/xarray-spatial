...
from xrspatial import flow_accumulation
...
def test_known_bowl():
    """5×5 bowl: hand-computed flow_dir and expected accum.
...
def test_pit_center():
    """3×3 grid, all 8 neighbours flow to center → center accum = 9."""
    flow_dir = np.array([
        [2.0, 4.0, 8.0],
        [1.0, 0.0, 16.0],
        [128.0, 64.0, 32.0],
...
def _make_cross_backend_flow_dir():
    """6×6 flow-east grid for cross-backend comparison."""
