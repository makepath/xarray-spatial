...
from xrspatial.hydrology.flow_accumulation import _code_to_offset
from xrspatial.hydrology.watershed import _code_to_offset_py
...
def _compute_seeds_upstream(iy, ix, boundaries, flow_bdry,
    ...
    from xrspatial.hydrology.flow_accumulation import _compute_seeds as _compute_accum_seeds
