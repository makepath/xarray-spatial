...
from xrspatial.hydrology.flow_accumulation_dinf import flow_accumulation_dinf
from xrspatial.hydrology.flow_accumulation import _detect_flow_type
...
def test_dinf_end_to_end():
    ...
    from xrspatial.hydrology import flow_direction_dinf
